...
use App\Write\Application\UseCase\CreateRoom\CreateRoomCommand;
...
class CreateRoomController extends AbstractController
{
    ...
    #[OA\Post(
        ...
        description: 'Requiere el permiso "rooms.manage".',
        tags: ['Salas'],
        security: [['bearerAuth' => []]],
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        return $this->apiResponse->success($response->serialize(), 'controller.room.created', Response::HTTP_CREATED);
    }
}
